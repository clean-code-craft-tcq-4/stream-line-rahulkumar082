...
void TEST_CASE_02()
{
  ...
  int size_02=10;
  assert(FindMaximumValue(&temperature_02[0],size)==89.5);
  assert(FindMaximumValue(&soc_02[0],size)==98);
  assert(FindMinimumValue(&temperature_02[0],size)==1.5);
  assert(FindMinimumValue(&soc_02[0],size)==1);
}
void TEST_CASE_03()
{
